...
{
    /// <summary>
    /// Description of DamageCalc403a.
    /// </summary>
    public sealed class DamageCalc403a : DamageCalc
    {
        public DamageCalc403a ()
            : base(new Simulator403a())
        {
            Handlers["MH:Melee"] = (_) =>
            {
            ...
            {
                var evt = WeaponDamageAttack(3.3, 1.15);
                evt.Spell = spell;
                ScaleDamage(evt, 1.2); // 2H spec

...
{
    /// <summary>
    /// Description of Simulator406.
    /// </summary>
    public sealed class Simulator406 : Simulator
    {
        public Simulator406 ()
        {
            InitBuffs();
        ...
        public override int EffectiveHolyPower { get { return Buff("Divine Purpose").IsActive ? 3 : base.EffectiveHolyPower; } }
        ...
        private void InitBuffs ()
        {
            ...
            b = new Buff(this, Secret, "Divine Purpose", () => TimeSpan.FromSeconds(8));
            AddBuff(b);
